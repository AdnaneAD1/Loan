                ...
                <div className="max-w-sm w-full space-y-8">
                    <form onSubmit={submitForm} className="mt-12 space-y-6 mb-12" enctype="multipart/form-data">
                        <div className="rounded-md shadow-sm -space-y-px">
                            ...
                            {/* Adresse Rue */}
                            <div className="mt-4">
                                <Label htmlFor="adresseRue">Adresse Rue</Label>
                                <Input
                                    id="adresseRue"
                                    type="text"
                                    value={adresseRue}
                            ...
                            {/* Numéro Identité */}
                            <div className="mt-4">
                                <Label htmlFor="numeroIdentite">Numéro Identité</Label>
                                <Input
                                    id="numeroIdentite"
                                    type="text"
                            ...
                            {/* Source de Revenu */}
                            <div className="mt-4">
                                <Label htmlFor="sourceRevenu">Source de Revenu</Label>
                                <Input
                                    id="sourceRevenu"
                                    type="text"
                                    value={sourceRevenu}
                            ...
                            {/* Statut Emploi */}
                            <div className="mt-4">
                                <Label htmlFor="statutEmploi">Statut Emploi</Label>
                                <Input
                                    id="statutEmploi"
                                    type="text"
                                    value={statutEmploi}
                            ...
                            <div className="mt-4">
                                <Label htmlFor="informationsBancaires">Informations Bancaires</Label>
                                <Input
